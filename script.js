...
document.querySelector('.whatsapp-link').addEventListener('click', function() {
    // You can add analytics tracking here
    console.log('WhatsApp button clicked with pre-filled message');
    
    // Optional: For more advanced tracking
    // gtag('event', 'click', { 'event_category': 'WhatsApp', 'event_label': 'Pre-filled Message' });
});